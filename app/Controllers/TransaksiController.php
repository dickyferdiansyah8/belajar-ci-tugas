...
class TransaksiController extends BaseController
{
    ...
    public function cart_add()
    {
        ...
        $today = date('Y-m-d');
        $rowDiskon = $this->diskonModel->where('tanggal', $today)->first();
        $nomDiskon = $rowDiskon ? (int) $rowDiskon['nominal'] : 0;
        $hargaSetelahDiskon = max(0, $hargaAsli - $nomDiskon);

        session()->set('diskon', $nomDiskon);
